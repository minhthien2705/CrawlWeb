...
class BooksCrawlSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        super(BooksCrawlSpider, self).__init__(*args, **kwargs)
        self.pages_crawled = 0

    def start_requests(self):
        start_page = 2  # Trang bắt đầu muốn cào
        end_page = 6  # Trang kết thúc muốn cào (không bao gồm)
    
        for page_num in range(start_page, end_page):
            url = f"https://books.toscrape.com/catalogue/category/books/default_15/page-{page_num}.html"
